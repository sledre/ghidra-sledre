...
public class HttpPostMultipart {
     ...
     * @throws IOException
     */
    public HttpPostMultipart(URL url, String charset, Map<String, String> headers) throws IOException {
     ...
     * @throws IOException
     */
    public void addFilePart(String fieldname, String filename, PipedInputStream in)
            throws IOException {
        writer.append("--" + boundary).append(LINE);
